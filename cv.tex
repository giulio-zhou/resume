...
\vspace{-2.5mm}
% \item Designed a general-purpose system for real-time covariate shift detection (via classification and hypothesis testing) and adaptation (through online reweighted model retraining)
% \vspace{-2.5mm}
...
\vspace{-2.5mm}
\item Coordinated Tau Beta Pi website hackathons, where participants work in teams on novel website features; notable projects include search autocompletion, Alumni Database prototype
\end{itemize}
